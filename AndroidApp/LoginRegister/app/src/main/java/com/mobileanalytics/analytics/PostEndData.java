 ...
 */
public class PostEndData extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            data += "&" + URLEncoder.encode("ts", "UTF-8") + "=" + URLEncoder.encode(params[11], "UTF-8"); //TimeSpent
            data += "&" + URLEncoder.encode("rtc", "UTF-8") + "=" + URLEncoder.encode(((Long.toString(System.currentTimeMillis()/1000))), "UTF-8"); //RecordTimestampCreated
            ...
            try
            {
                ...
                URL url = new URL("http://54.254.253.37/api/data/E");
